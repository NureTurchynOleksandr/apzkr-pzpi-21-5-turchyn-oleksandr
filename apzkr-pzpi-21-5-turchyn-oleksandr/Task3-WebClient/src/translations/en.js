const TRANSLATIONS_EN = {
  ...
  dish: {
    ...
    weight: "pounds",
    volume: "cubic foots",
    add_to_order: "Add to the order",
    dish_added_to_cart: "The dish is added to cart",
  ...
  dish_search: {
    ...
    dishes_with_ingredients:
      "The dishes that contains all the chosen ingredients",
    dishes_with_absent_ingredients:
      "The dishes that don't contain any ingredients",
  },
  catering_establishment_search: {
    dishes: "Dishes",
    find_catering_establishments: "Find the catering establishments",
    found_catering_establishments:
      "The catering establishments that were found",
  },
  registration: {
    empty_username_warning: "The user name should not be empty",
    username_spaces_warning:
      "The user name should not contain space characters",
    non_appropriate_symbols_username_warning:
      "The user name must consist of only latin letters and digits",
    ...
    success_registration:
      "You was successfully registered. Now you can log in.",
    ok: "Ok",
  },
  authorization: {
  ...
  administration: {
    ...
    restore_success:
      "Database was successfully restores to the previous state.",
