# Generated by Django 3.1.3 on 2024-04-04 20:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='cateringEstablishmentImages/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('popularity', models.CharField(blank=True, max_length=20)),
        ...
        migrations.CreateModel(
            name='CateringEstablishmentAutomaticMachine',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('automatic_machine_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.automaticmachinetype')),
                ('catering_establishment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.cateringestablishment')),
            ],
        ),
        migrations.CreateModel(
            name='AutomaticMachineDish',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('automatic_machine_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.automaticmachinetype')),
                ('dish', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.dish')),
